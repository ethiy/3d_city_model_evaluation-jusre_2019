    ...
    }
    {
        ...
        \StandardBox{state_art}{column=4, span=2, aligned=context, bottomaligned=context}{State of the art classification}{
            ...
            \begin{itemize}[label=--, leftmargin=1em]
                \item {\color{IGNGreen} geometric fidelity metrics} usually comparing to {\color{orange} higher precision} models~\cite{vogtle2003quality, Henricsson1997}.
        ...
        \StandardBox{samples}{column=3, span=3, aligned=taxonomy}{Errors samples}{
         ...
         \StandardBox{dataset}{column=0, span=3, below=taxonomy}{Dataset details}{
            \begin{center}
        		\scriptsize
        ...
        \StandardBox{ablation}{column=0, span=3, below=dataset}{Ablation study: Elancourt case}{
            \begin{center}
                \scriptsize
