...
\begin{document}
    ...
    \begin{tikzpicture}
    	\node (residual) at (0,0) {\includegraphics[height=1cm, angle=270]{images/graphical_abstract/residual}};
        ...
        \path (residual.east) + (.8,0) node (ortho_projection) {\includegraphics[height=1cm, angle=270]{images/graphical_abstract/orthoprojection}};
