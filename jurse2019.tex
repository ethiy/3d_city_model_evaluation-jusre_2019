...
\begin{table*}
	\begin{center}
		...
		\begin{tabular}{|x{1cm} | x{1.3cm} x{1.3cm} | x{1.2cm} x{1.2cm} | x{1.2cm} x{1.2cm}| x{1.2cm} x{1.2cm}|}
            ...
            \hline
            \textit{BInT} & \textcolor{darkgreen}{40.71} & 14.24 & 0 & --- & 4.70 & 100 & 4.44 & 100 \\
            \hline
            \hline
            \textit{FOS} & \textcolor{darkgreen}{100} & 69.38 & 98.80 & 96.47 & 98.76 & 98.92 & 99.06 & 97.14 \\
            \hline
            \textit{FUS} & 15.71 & 56.90 & 20.73 & 91.94 & 1.68 & 77.78 & 3.53 & 89.47 \\
            \hline
            \textit{FIB} & \textcolor{darkgreen}{83.54} & 43.08 & \textcolor{darkgreen}{39.58} & 64.04 & 23.75 & 73.96 & 21.86 & 70.11 \\
            \hline
            \textit{FIT} & 9.09 & 33.33 & 0 & 0 & 3.57 & 100 & 4.34 & 33.33 \\
            \hline
            \textit{FIG} & \textcolor{darkgreen}{100} & 64.45 & \textcolor{darkgreen}{90.86} & \textcolor{darkgreen}{86.14} & 86.35 & 67.97 & 82.38 & 73.08 \\
            \hline
        \end{tabular}
        \vspace{-.5cm}
