...
\begin{table*}
	\begin{center}
		\begin{tabular}{|x{1cm} | x{1.3cm} x{1.3cm} | x{1.2cm} x{1.2cm} | x{1.2cm} x{1.2cm}|}
            ...
            \hline
            \textit{BOS} & 90.83 & 76.14 & 93.12 & 42.61 & 96.53 & 43.82 \\
            \hline
            \textit{BUS} & 39.32 & 71.81 & 8.82 & 66.67 & 0 & --- \\
            \hline
            \textit{BImB} & 16.75 & 68.0 & 2.02 & 33.33 & 0 & --- \\
            \hline
            \textit{BInT} & 11.11 & 91.67 & 0.88 & 100 & 3.95 & 50.0 \\
            \hline
            \hline
            \textit{FOS} & 98.91 & 98.84 & 98.33 & 97.92 & 97.19 & 97.58 \\
            \hline
            \textit{FUS} & 1.27 & 66.67 & 13.81 & 63.04 & 8.36 & 95.83 \\
            \hline
            \textit{FImB} & 7.42 & 100 & 46.34 & 65.52 & 11.80 & 60.71 \\
            \hline
            \textit{FImT} & 3.33 & 100 & 9.09 & 100 & 0 & 0 \\
            \hline
            \textit{FIG} & 79.02 & 71.82 & 94.17 & 70.70 & 86.16 & 88.47 \\
            \hline
        \end{tabular}
	\end{center}
\end{table*}
