...
\begin{table*}
	...
	\begin{center}
        \begin{tabular}{|x{1.4cm} | x{1.2cm} x{1.2cm} | x{1.2cm} x{1.2cm} | x{1.2cm} x{1.2cm} | x{1.2cm} x{1.2cm}|}
            ...
            \hline
            \textit{BOS} & 93.96 & 76.15 & 91.43 & 77.76 & 91.51 & 76.08 & 90.83 & 76.14 \\
            \hline
            \textit{BUS} & 32.98 & 76.47 & 41.86 & 75.57 & 40.38 & 71.00 & 39.32 & 71.81 \\
            \hline
            \textit{BIB} & 12.32 & 67.57 & 12.81 & 68.42 & 16.26 & 67.35 & 16.75 & 68.0 \\
            \hline
            \textit{BIT} & 25.25 & 92.59 & 20.20 & 90.91 & 20.20 & 95.24 & 11.11 & 91.67 \\
            \hline
            \hline
            \textit{FOS} & 98.91 & 99.07 & 98.91 & 99.30 & 98.99 & 98.84 & 98.91 & 98.84 \\
            \hline
            \textit{FUS} & 1.90 & 54.55 & 0.63 & 66.67 & 1.61 & 50 & 1.27 & 66.67 \\
            \hline
            \textit{FIB} & 9.17 & 87.5 & 0 & -- & 8.30 & 82.61 & 7.42 & 100 \\
            \hline
            \textit{FIT} & 6.67 & 100 & 8.73 & 95.24 & 3.33 & 100 & 3.33 & 100 \\
            \hline
            \textit{FIG} & 80.54 & 73.14 & 80.45 & 72.62 & 78.69 & 72.12 & 79.02 & 71.82 \\
            \hline
		\end{tabular}
	\end{center}
    \vspace{-.5cm}
...
\begin{table*}
	\begin{center}
		...
		\begin{tabular}{|x{1cm} | x{1.3cm} x{1.3cm} | x{1.2cm} x{1.2cm} | x{1.2cm} x{1.2cm}| x{1.2cm} x{1.2cm}|}
            ...
            &\textbf{Recall} & \textbf{Prec.} & \textbf{Recall} & \textbf{Prec.} & \textbf{Recall} & \textbf{Prec.} & \textbf{Recall} & \textbf{Prec.} \\
            \hline
            \textit{BOS} & 100 & 42.05 & 78.71 & 42.97 & 86.47 & 64.99 & 82.14 & 69.59 \\
            \hline
            \textit{BUS} & 19.12 & 54.17 & 4.76 & 27.27 & 23.75 & 57.47 & 25.0 & 50.49 \\
            \hline
            \textit{BImB} & 0 & --- & 1.85 & 33.33 & 15.65 & 46.75 & 19.89 & 48.05 \\
            \hline
            \textit{BInT} & 40.71 & 14.24 & 0 & --- & 4.70 & 100 & 4.44 & 100 \\
            \hline
            \hline
            \textit{FOS} & 100 & 69.38 & 98.80 & 96.47 & 98.76 & 98.92 & 99.06 & 97.14 \\
            \hline
            \textit{FUS} & 15.71 & 56.90 & 20.73 & 91.94 & 1.68 & 77.78 & 3.53 & 89.47 \\
            \hline
            \textit{FIB} & 83.54 & 43.08 & 39.58 & 64.04 & 23.75 & 73.96 & 21.86 & 70.11 \\
            \hline
            \textit{FIT} & 9.09 & 33.33 & 0 & 0 & 3.57 & 100 & 4.34 & 33.33 \\
            \hline
            \textit{FIG} & 100 & 64.45 & 90.86 & 86.14 & 86.35 & 67.97 & 82.38 & 73.08 \\
            \hline
        \end{tabular}
        \vspace{-.5cm}
