...
\begin{table*}
	\begin{center}
		...
		\begin{tabular}{|x{1cm} | x{1.3cm} x{1.3cm} | x{1.2cm} x{1.2cm} | x{1.2cm} x{1.2cm}| x{1.2cm} x{1.2cm}|}
            ...
            &\textbf{Recall} & \textbf{Prec.} & \textbf{Recall} & \textbf{Prec.} & \textbf{Recall} & \textbf{Prec.} & \textbf{Recall} & \textbf{Prec.} \\
            \hline
            \textit{BOS} & \textcolor{green}{100} & 42.05 & 78.71 & 42.97 & 86.47 & 64.99 & 82.14 & 69.59 \\
            \hline
            \textit{BUS} & 19.12 & 54.17 & 4.76 & 27.27 & 23.75 & 57.47 & 25.0 & 50.49 \\
            \hline
            \textit{BImB} & 0 & --- & 1.85 & 33.33 & 15.65 & 46.75 & 19.89 & 48.05 \\
            \hline
            \textit{BInT} & \textcolor{green}{40.71} & 14.24 & 0 & --- & 4.70 & 100 & 4.44 & 100 \\
            \hline
            \hline
            \textit{FOS} & \textcolor{green}{100} & 69.38 & 98.80 & 96.47 & 98.76 & 98.92 & 99.06 & 97.14 \\
            \hline
            \textit{FUS} & 15.71 & 56.90 & 20.73 & 91.94 & 1.68 & 77.78 & 3.53 & 89.47 \\
            \hline
            \textit{FIB} & \textcolor{green}{83.54} & 43.08 & \textcolor{darkgreen}{39.58} & 64.04 & 23.75 & 73.96 & 21.86 & 70.11 \\
            \hline
            \textit{FIT} & 9.09 & 33.33 & 0 & 0 & 3.57 & 100 & 4.34 & 33.33 \\
            \hline
            \textit{FIG} & \textcolor{green}{100} & 64.45 & \textcolor{darkgreen}{90.86} & \textcolor{darkgreen}{86.14} & 86.35 & 67.97 & 82.38 & 73.08 \\
            \hline
        \end{tabular}
        \vspace{-.5cm}
