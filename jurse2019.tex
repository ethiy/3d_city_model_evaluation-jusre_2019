...
From table~\ref{tab::ablation}, we can see that well represented errors are well detected. In fact, \textit{BOS} (\textit{resp.} \textit{FOS}, \textit{FIB}), with a $66.80\%$ (\textit{resp.} $64.16\%$, $59.08\%$) presence ratio, attains, in average across all feature configurations, a high recall ratio of $91.93\%$ (\textit{resp.} $98.93\%$, $79,68\%$).
